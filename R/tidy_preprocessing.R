...
split_cells <- function(cells) {
    ...
    corners <- cells %>%
        filter(
            ...
            str_detect(.data$value, r"(User|Raw Data|Well$|Basic settings|General settings)")
        )
